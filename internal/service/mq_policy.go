...
// P2 修复(2026-09-15)：话术统一去"您"改"你"（AGENTS 去 AI 味铁律）；:23/:107 处"您好"是客户输入匹配词，保留
...
var storeVisitSecondReplies = []string{
	"麻烦发一下姓名和电话，预计几位过来，方便的试驾时间，还有其他想了解的也一块说下，我来给你预约",
	"你方便留个姓名和手机号吗？另外大概几位过来、啥时候方便试驾，有啥特别想了解的也告诉我，我给你安排好",
	"帮我留个姓名电话呗，还有大概几个人来、想啥时候试驾，有啥特别需求也一起说，我这边给你约好",
	"你发我一下姓名和联系方式吧，还有几个人来、方便的时间，以及其他想了解的，我来安排预约",
}
