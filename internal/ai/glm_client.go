...
func (c *GLMClient) mockGenerate(messages []ChatMessage) string {
	...
	// 简单的规则模拟回复（泛行业化 P2：去汽车专属词，改中性话术；真实行业语义由提示词/行业包承载）
	switch {
	case containsKeyword(lastUserMsg, "价格", "多少钱", "贵", "优惠"):
		return "价格要看具体配置和你的需求来定，要不我帮你详细算一下？你先说说大概关注哪个方向，我这边好给你介绍。"
	case containsKeyword(lastUserMsg, "配置", "性能", "参数"):
		return "这款产品的配置挺丰富的，亮点和细节都不少。你对哪方面比较感兴趣？我帮你具体讲讲，也能根据你的实际需求帮你参谋。"
	case containsKeyword(lastUserMsg, "到店", "体验", "看看"):
		return "欢迎你到店里来体验！你什么时候方便？我帮你约好，到时候安排专人给你一对一介绍。"
	...
	default:
		return "明白了，你的需求我先记下了。为了更好帮你，能说说你的大概预算和比较在意的点吗？我好针对性地帮你介绍。"
	}
}
